...
public class EditProfilePresenter implements EditProfileContract.Presenter {
    ...
    @Override
    public void bindView(EditProfileContract.View view) {
        mView = view;
    }
    ...
    @Override
    public void updateProfile(UserRegistration user) {
                    ...
                    public void onNext(Response<User> response) {
                        ...
                        if (mView != null) {
                            ...
                            if (response.isSuccessful()) {
                                mView.showUpdateProfileSuccess();
                                mView.launchProfileFragment(response.body());
